...
Report this as a standalone section in every generated child-skill review. Do not satisfy this checklist only through the main weakness table. Cover every applicable flaw type, and mark non-applicable items as `not applicable` with a short reason.
